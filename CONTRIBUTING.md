...
Commit messages follow the standard [conventional commits][conventional-commits]
...
* Go to the issue tracker and [filter open issues by the `support` label][support-open-issues].
...
PR reviews use [GitHub's own review feature](https://help.github.com/articles/about-pull-request-reviews/),
...
[issues-prs-cleanup]: https://github.com/tvcsantos/sechub-reporter-action/blob/develop/CONTRIBUTING.md#clean-up-issues-and-prs
[issue-tracker]: https://github.com/tvcsantos/sechub-reporter-action/issues
[pull-requests]: https://github.com/tvcsantos/sechub-reporter-action/pulls
[support-open-issues]: https://github.com/tvcsantos/sechub-reporter-action/issues?q=is%3Aopen+is%3Aissue+label%3Asupport
[unlabeled-open-issues]: https://github.com/tvcsantos/sechub-reporter-action/issues?q=is%3Aopen+is%3Aissue+no%3Alabel
